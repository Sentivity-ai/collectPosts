...
def scrape_threads(
    ...
    """
    Threads scraper - simplified to avoid slow HTML scraping
    Threads requires authentication and blocks web scraping, so returns empty
    """
    posts = []
    ...
    print(f"⚠️ Threads scraping skipped - requires authentication and web scraping is too slow/unreliable")
    print(f"⚠️ Threads API not available. Returning empty results.")
